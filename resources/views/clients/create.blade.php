<x-sidebar-layout title="クライアント登録">
<div class="p-6 max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">新規クライアント登録</h1>
    </div>

    <form method="POST" action="{{ route('clients.store') }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        @csrf
